...
//    private static final String SETTINGS_NAME = "default_settings";
    private static final String SETTINGS_NAME = "pref_key_quran";
...
//        public static final String CALC_METHOD = "calc_method_for_%d";
    ...
    public void setCalcMethodFor(int index, int value) {
        set(Key.CALC_METHOD, value);
    }

    public int getCalcMethodFor(int index) {
//        return getInt(Key.CALC_METHOD, PrayTime.SIHAT);
        return getInt(Key.CALC_METHOD, index);
    }

    public int getAsrMethodSetFor(int index) {
        return getInt(Key.ASR_METHOD, index);
    }
    ...
    public int getHighLatitudeAdjustmentFor(int index) {
        return getInt(getKeyFor(Key.ADJUST_METHOD, index), index);
    }
